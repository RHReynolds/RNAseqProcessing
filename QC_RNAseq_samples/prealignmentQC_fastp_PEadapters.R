## This script runs fastp without any "Per read cutting by quality options". 
## No adapter sequences have been specified.

#---Load Libraries and data--------------------------------------------------------------------------------------------------------------####
library(tidyverse)
library(stringr)

source(here::here('R', 'prealignmentQC_CommonTrimmingFunctions.R'))
