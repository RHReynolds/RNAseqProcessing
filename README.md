...
## Scripts for QC and alignment
 ...
 [STAR_alignment_1pass.R](alignment/STAR_alignment_1pass.R) | Alignment | Performs STAR alignment, using 1-pass mapping. This script can be combined with [STAR_alignment_multi2pass.R](alignment/STAR_alignment_multi2pass.R) for multi-sample 2-pass mapping. For details of alignment process, read the [alignment workflow](alignment/alignment.md). **N.B. This script is currently optimised for 100bp reads.** | DZ
 [STAR_alignment_withReadGroups_1pass.R](alignment/STAR_alignment_withReadGroups_multi2pass.R) | Alignment | Performs STAR alignment, using 1-pass mapping, and adds read groups, which can be used for later de-duplication with UMIs. This script can be combined with [STAR_alignment_multi2pass.R](alignment/STAR_alignment_multi2pass.R) for multi-sample 2-pass mapping. For details of alignment process, read the [alignment workflow](alignment/alignment.md). **N.B. This script is currently optimised for 100bp reads.** | DZ & RHR
