...
## Scripts for QC and alignment
 ...
 [STAR_alignment.R](alignment/STAR_alignment.R) | Alignment | Performs STAR alignment. For details of alignment process, read the [alignment workflow](alignment/alignment_workflow.md). **Note that this script is currently optimised for 100bp reads.** | DZ
 [STAR_alignment_withReadGroups.R](alignment/STAR_alignment_withReadGroups.R) | Alignment | Performs STAR alignment and adds read groups, which can be used for later de-duplication with UMIs. For details of alignment process, read the [alignment workflow](alignment/alignment_workflow.md). **Note that this script is currently optimised for 100bp reads.** | DZ & RHR
